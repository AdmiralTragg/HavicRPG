package ThePlayerHaze.UnnamedMod.Mobs.entity;
...
public class EntityCorthex extends EntityAnimal
{
    public EntityCorthex(World par1World)
    {
        super(par1World);
     ...
     */
    public EntityCorthex spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return new EntityCorthex(this.worldObj);
    }
