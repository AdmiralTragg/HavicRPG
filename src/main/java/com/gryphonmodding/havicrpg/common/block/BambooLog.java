...
public class BambooLog extends Block {
	...
	public void registerIcons(IconRegister par1IconRegister) {
		this.blockIcon = par1IconRegister.registerIcon("yargmod:silverLog_Side");
		this.iconLogBottom = par1IconRegister.registerIcon("yargmod:silverLog_Bottom");
		this.iconLogTop = par1IconRegister.registerIcon("yargmod:silverLog_Top");
	}
